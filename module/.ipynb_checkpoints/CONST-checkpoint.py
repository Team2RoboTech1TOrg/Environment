...
ENERGY_RECHARGE_AMOUNT = 1000
WATER_REFILL_AMOUNT = 50
COUNT_ACTIONS = 6
MAX_STEPS_WITHOUT_PROGRESS = 500
MAX_ENERGY_WITHOUT_PROGRESS = 500
MAX_HOLE_FALL = 5
MAX_TIME = 3000
...
REWARD_WATER_FAIL_NOT_ON_FLOWER = -500
REWARD_RECHARGE = -10
REWARD_REFILL = -10
REWARD_COLLISION = -500  # штраф за попадание в яму
REWARD_EXPLORE = 50  # Штраф за ненужное исследование
REWARD_AVOID_HOLE = 50  # Вознаграждение за обход ям
REWARD_TIME = lambda t: 10 / t if t > 0 else 0
REWARD_STEPS = lambda m: 10 / m if m > 0 else 0
PENALTY_LOOP = -10
